...
public class Alertas {
    ...
    private static void showStyledAlert(String title, String message, AlertType type, String styleClass) {
        ...
        alert.getDialogPane().getStylesheets().add(
            Alertas.class.getResource("/application/application.css").toExternalForm()
        );
        ...
        try {
            ...
            stage.getIcons().add(new Image(Alertas.class.getResourceAsStream("/application/imagenes/icon.png")));
        } catch (Exception e) {
            System.err.println("Error al cargar el icono de la alerta");
        }
        
        alert.show(); // Cambiado de showAndWait() a show() para evitar problemas de bloqueo
    }
}