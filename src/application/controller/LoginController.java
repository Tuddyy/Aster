...
public class LoginController {
    ...
    public void initialize() {
        ...
        logoImage.setImage(loadImage("/application/imagenes/Logo.png"));
        usuarioImage.setImage(loadImage("/application/imagenes/usuario.png"));
        passwordImage.setImage(loadImage("/application/imagenes/contraseña.png"));
        usuariosImage.setImage(loadImage("/application/imagenes/usuarios.png"));
    }
    ...
    void handleLogin(ActionEvent event) {
        ...
        try (Connection conn = DatabaseConnector.connect()) {
            ...
            if (rs.next()) {
                ...
                stage.getIcons().add(loadImage("/application/imagenes/icon.png"));
                stage.show();
